...
public class DangKyKhoaHoc extends javax.swing.JFrame {
    ...
    public void loadData(List<HocVien> list) {
        DefaultTableModel DFT = (DefaultTableModel) tblHV.getModel();
        DFT.setRowCount(0);
        for (HocVien hv : list) {
            DFT.addRow(new Object[]{
                hv.getId(), hv.getHoTen(), hv.getNgaySinh(), hv.getEmail(), hv.getSoDienThoai(), hv.getGioiTinh(), hv.getTrangThai()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        tblHV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên", "NgaySinh", "Email", "SĐT", "GioiTinh", "TrangThai"
            }
        ));
        jScrollPane1.setViewportView(tblHV);
        if (tblHV.getColumnModel().getColumnCount() > 0) {
            tblHV.getColumnModel().getColumn(5).setResizable(false);
            tblHV.getColumnModel().getColumn(5).setHeaderValue("GioiTinh");
            tblHV.getColumnModel().getColumn(6).setHeaderValue("TrangThai");
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (selectedRow >= 0) {
            String idHocVien = tblHV.getValueAt(selectedRow, 0).toString();
            new DangKyLop(idHocVien).setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Phải chọn học viên thì mới chọn khóa học để đăng ký");
        }
